class Theme {
    ...
    init() {
        ...
        for (const box of Object.values(this.boxes)) {
            ...
            theme_container === null || theme_container === void 0 ? void 0 : theme_container.appendChild(box_el);
        }
    }
    create_color_box(box) {
    ...
    add_action_handlers(color_input, box) {
